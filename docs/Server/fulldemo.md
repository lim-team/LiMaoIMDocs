...
services:
  limaoserver:
      image: registry.cn-shanghai.aliyuncs.com/limao/limaoserver:latest
      restart: always
      command: "api"
      healthcheck:
      ...
      environment:
        ...
        - IMURL=http://proxy:18029 # limao im proxy服务器地址（内网地址）
        ...
        - MySQLAddr=root:pwd@tcp(mysql)/im?charset=utf8mb4&parseTime=true&loc=Local # mysql数据库连接地址
